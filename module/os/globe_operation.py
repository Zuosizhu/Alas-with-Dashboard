...
class GlobeOperation(ActionPointHandler):
    ...
    def get_zone_select(self):
        ...
        return [
            ...
            if self.appear(select, offset=self._zone_select_offset, threshold=self._zone_select_similarity)
        ]
    ...
    def zone_select_execute(self, button):
        ...
        self.ui_click(button, appear_button=appear, check_button=self.is_zone_pinned, skip_first_screenshot=True)
